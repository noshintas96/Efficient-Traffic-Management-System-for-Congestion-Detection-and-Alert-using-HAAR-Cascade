...
# gp.setmode(gp.BOARD)
#
# all_pin = [11, 13, 15, 12, 16, 18, 29, 31, 33]
# for p in all_pin:
#     gp.setup(p, gp.OUT)
#
#
...
#     gp.output(11, 0)
#     for i in range(1, 3):
#         gp.output(all_red[i], 1)
#     for p in all_ylw:
#         gp.output(p, 0)
#     for i in range(1, 3):
#         gp.output(all_green[i], 0)
#
#
# time.sleep(t)
#
...
while True:
    ...
    if ret:
        ...
        right_car = car_cascade_2.detectMultiScale(right_lane, 1.10, 1, minSize=(40, 30), maxSize=(80, 70))
